...
local myawesomemenu = {
    ...
    { "edit config", terminal.." vim /home/ian/.config/awesome/rc.lua" },
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, altkey }, "b", function () awful.util.spawn( "firefox https://www.google.com" ) end,
        {description = "firefox" , group = "gui apps" }),
    awful.key({ modkey, altkey }, "e", function () awful.util.spawn( terminal.." -e vi" ) end,
...
awful.spawn.with_shell("redshift -l 41:-71 -m vidmode")
